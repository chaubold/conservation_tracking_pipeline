...
int main(int argc, char** argv) {
  ...
  try {
    ...
    vector<MultiArray<3, unsigned> > label_images;
    int timestep = 0;
	...
	vigra::ConvolutionOptions<3> opt;
	...
	int feature_status = get_features<3>(src, features[features.size()-1], it->first, feature_sigma, window_size);
